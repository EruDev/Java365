package com.github.java.geektime.concurrency.features.completablefuture;

import com.github.java.geektime.concurrency.ThreadUtil;
...
public class CompletableFutureEx {
    ...
    public static void main(String[] args) {
        CompletableFutureEx example = new CompletableFutureEx();
